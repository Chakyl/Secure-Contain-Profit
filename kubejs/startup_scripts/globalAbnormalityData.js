...
global.ABNORMALITIES = new Map([
    ...
    ["minecraft:creeper", { class: "verdant", name: "Little Bit of Spark", counter: 14, breachTypes: ["STEAMROLLER"], evolutions: ["creaturefeature:eeper"] }],
    ["creaturefeature:eeper", { class: "verdant", name: "Little Bit of Sleep", counter: 10, breachTypes: ["TELEPORT"] }],
    // Pathogen
    ...
    ["creaturefeature:stained_glass", { class: "verdant", name: "Whispershard", counter: 6, breachTypes: ["DISSOLVE", "TELEPORT"] }],
    ["creaturefeature:mockingbird", { class: "verdant", name: "Crude Drawing of an Angel", counter: 6, breachTypes: ["DISSOLVE", "SAP"] }],
    ["peaceless:harpy", { class: "verdant", name: "TU AMIGO", counter: 6, breachTypes: ["DISSOLVE", "DECOUNT"] }],
    // Villager
    ["minecraft:villager", { class: "verdant", name: "The Architect", counter: 14, breachTypes: ["DISSOLVE"], evolutions: ["minecraft:zombie_villager", "minecraft:zombie"] }],
    ["minecraft:zombie_villager", { class: "verdant", name: "The Painter", counter: 14, breachTypes: ["DISSOLVE"], evolutions: ["creaturefeature:blossom"] }],
    ["minecraft:zombie", { class: "verdant", name: "Live From Hell", counter: 14, breachTypes: ["SAP", "DISSOLVE"], evolutions: ["creaturefeature:minds"] }],
    ["creaturefeature:blossom", { class: "verdant", name: "Flatbush", counter: 7, breachTypes: ["SAP", "STEAMROLLER"] }],
    ["creaturefeature:minds", { class: "verdant", name: "Minehuck", counter: 14, breachTypes: ["SAP", "DISSOLVE"] }],
    // Frog
    ["minecraft:frog", { class: "verdant", name: "Cornelius the Frog", counter: 99, breachTypes: ["NOTHING"], evolutions: ["companions:cornelius"] }],
    ["companions:cornelius", { class: "verdant", name: "Cornelius the Frog UNCHAINED", counter: 99, breachTypes: ["NOTHING"] }]
]);